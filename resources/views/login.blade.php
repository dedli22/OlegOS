...
<div class="w-3/4 float-left ml-10 mb-10 mt-5">
            ...
            <form method="POST" action="{{ route('login', app()->getLocale()) }}">
                ...
                <div>
                    ...
                    <input value="{{old('email')}}" type="email" name="email" required autofocus class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
