...
<ul class="capitalize">    
    ...
    <li class=" ">
        <a class="active block float-left w-auto border-l border-r border-t border-solid border-sky-500 ml-5 pl-3 text-center rounded-t-lg text-sky-500 font-bold pt-1 pr-3 h-[42.5px] bg-white mt-[-10px] hover:h-[42.5px] hover:bg-white hover:mt-[-10px]" href="{{ route('users.editProfilePicture', [Auth::user()->id, 'locale' => app()->getLocale()]) }}">
