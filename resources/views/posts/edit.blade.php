...
<div class="w-full m-5">
    <br><br>
    <div class="pageTitle text-sky-500 text-xl pl-3 font-bold text-left capitalize">@lang('admin.Title') » @lang('admin.NP Name') » @lang('admin.NP Edit Name')</div>
    <hr style="width: 75%; float: left; margin: 5px; height: 2px;" color="#019ad2">
                ...
                @csrf
                    <span>
                        <div class="float-left pt-5 w-1/4 text-gray-600">
                            <font color="red">*</font><b>@lang('admin.NP Edit Title')</b>
                        </div>
                        <div>
                    ...
                    <span>
                        <div class="float-left pt-5 w-1/4 text-gray-600">
                            <font color="red">*</font><b>@lang('admin.NP Edit Image')</b>
                        </div>
                        <div>
                    ...
                    <span>
                        <div class="float-left pt-5 w-1/4 text-gray-600">
                            <font color="red">*</font><b>@lang('admin.NP Edit Body')</b>
                        </div>
                        <div>
        ...
        <input class="float-left bg-sky-500 p-1 w-auto text-white rounded-lg hover:bg-sky-600 m-5 pl-5 pr-5" type="submit" value="@lang('admin.NP Edit Submit')" />
    </form>
</div>
@endsection