@foreach ($PageConfigs as $PageConfig)
    ...
    @else
        {{-- {{ redirect()->route('PageConfig.offline') }}  --}}
        {{-- {{ return redirect()->route('PageConfig.offline') }} --}}
        {{-- {{ return view('admin.PageConfig.show') }} --}}
        {{-- {{ return redirect()->to(route('PageConfig.offline')); }} --}}
        {{-- {{ return redirect()->away('https://google.com') }} --}}
        {{-- <script>window.location = "http://localhost/admin/PageConfig/offline";</script> --}}
